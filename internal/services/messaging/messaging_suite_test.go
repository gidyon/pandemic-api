...
var _ = BeforeSuite(func() {
	...
	fcmClient := &mocks.FCMClientMock{}
	fcmClient.On("Send", mock.Anything, mock.Anything).
		Return(&fcm.Response{}, nil)
	fcmClient.On("SendWithRetry", mock.Anything, 5).
		Return(&fcm.Response{}, nil)
	fcmClient.On("SendWithContext", mock.Anything, mock.Anything).
		Return(&fcm.Response{}, nil)
