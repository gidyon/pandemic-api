...
var (
	...
	pattern_Messaging_ReadAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"api", "v1", "messaging", "messages", "phone_number", "readall"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Messaging_GetNewMessagesCount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"api", "v1", "messaging", "messages", "phone_number", "newcount"}, "", runtime.AssumeColonVerbOpt(true)))
)
